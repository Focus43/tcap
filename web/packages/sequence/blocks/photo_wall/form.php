    ...
    <div class="controls-wrap">
        <div class="inner">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-3">
                        <?php echo $form->select('fileSource', \Concrete\Package\Sequence\Block\PhotoWall\Controller::$fileSourceOptions, $this->controller->fileSource); ?>
                    </div>
                    <div class="col-sm-9" data-source-method="<?php echo \Concrete\Package\Sequence\Block\PhotoWall\Controller::FILE_SOURCE_CUSTOM; ?>">
                        <button type="button" class="btn btn-default btn-block" add-file>Add Image</button>
                    </div>
                    <div class="col-sm-9" data-source-method="<?php echo \Concrete\Package\Sequence\Block\PhotoWall\Controller::FILE_SOURCE_SET; ?>">
...
<script type="text/javascript">
    $(function(){
        _photoWallHandler({
            sourceMethod: {
                custom: <?php echo \Concrete\Package\Sequence\Block\PhotoWall\Controller::FILE_SOURCE_CUSTOM; ?>,
                fileSet: <?php echo \Concrete\Package\Sequence\Block\PhotoWall\Controller::FILE_SOURCE_SET; ?>
            },
